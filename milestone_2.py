...
async def main():
    models = ["ft:gpt-4o-mini-2024-07-18:personal:training-500-1:AGEaeIGG", "ft:gpt-3.5-turbo-1106:personal:training-500-1:AGFOg8us"]
    results = []

    for model in models:
        logging.info(f"Running vibe check for {model}...")
        result = await vibe_check("validation.jsonl", model)
